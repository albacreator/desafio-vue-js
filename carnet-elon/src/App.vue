  ...
  <div class="carnet">
    <aside>
      <div>
        ...
        <img width="40" :src="flagSrc" alt="Bandera de Chile" />
      </div>

      <img :src="photoSrc" alt="Foto del titular" />
      <p>RUN {{ run }}</p>
    </aside>
...
export default {
  ...
  data() {
    return {
      ...
      firma: 'X Æ A-12',
      flagSrc: require('@/assets/chile_bandera.png'),
      photoSrc: require('@/assets/foto_elon.jpg')
    }
  }
}
</script>
